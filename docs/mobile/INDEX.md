...
- [ANDROID_AI_BACKEND_BRIDGE_118.md](ANDROID_AI_BACKEND_BRIDGE_118.md) — Assistente IA nativo → backend Production (GOAL-118): CORS nativo do gateway, origem Production embutida no build mobile, deploy, smoke pelo app, offline/online, segredos e privacidade.
